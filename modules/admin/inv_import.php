                        ...
                        <?php else: ?>
                            <form method="post">
                                ...
                                <div class="mt-3 d-flex gap-2">
                                    ...
                                    <?php if ($editImport): ?>
                                        <a class="btn btn-outline-secondary" href="/erp/modules/admin/inv_import.php?<?= e(http_build_query(['tab' => 'history', 'month' => $filterMonth, 'item_id' => $filterItemId, 'payment_status' => $filterPaymentStatus])) ?>">Huỷ</a>
                                    <?php endif; ?>
                                </div>
                            </form>
                        <?php endif; ?>
