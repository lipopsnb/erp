...
// Danh sách phiếu nhận SX còn hàng chưa báo cáo đủ
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">
                <i class="fas fa-clipboard-list me-2 text-primary"></i>Output cuối ngày
            </h4>
            ...
            <form class="row g-2 align-items-center" method="GET">
                ...
                <div class="col-auto ms-auto">
                    <span class="badge bg-success fs-6 me-1">
                        <i class="fas fa-check me-1"></i>Hoàn thành: <?= number_format($totalOK) ?>
                    </span>
                    <span class="badge bg-danger fs-6 me-1">
                        <i class="fas fa-times me-1"></i>Lỗi: <?= number_format($totalNG) ?>
                    </span>
                    <span class="badge bg-primary fs-6">
                        <i class="fas fa-truck me-1"></i>Đã giao: <?= number_format($totalDelivered) ?>
                    </span>
                </div>
                <?php endif; ?>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <?php if (empty($outputs)): ?>
                        <tr><td colspan="10" class="text-center text-muted py-4">Chưa có output nào</td></tr>
                    <?php else: ?>
                        <?php foreach ($outputs as $o):
                            ...
                            $remaining = $o['quantity_completed'] - $o['qty_delivered_actual'];
                        ?>
                        <tr>
                    ...
                    <tfoot class="table-light fw-bold">
                        <tr>
                            ...
                            <td class="text-end text-warning">
                                <?= number_format(max(0, $totalOK - $totalDelivered)) ?>
                            </td>
                            <td class="text-center">
                                <?php $r = ($totalOK+$totalNG)>0
                                    ? round($totalOK/($totalOK+$totalNG)*100,1) : 0; ?>
...
<!-- Modal nhập output �� ĐÃ BỎ quantity_delivered -->
            ...
            <div class="modal-body">
                <form id="formOutput">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="production_receipt_id" id="selReceipt"
                                class="form-select" required>
                            <option value="">-- Chọn phiếu nhận còn hàng --</option>
                            <?php foreach ($receiptList as $rl):
                                $remaining = $rl['quantity_received'] - $rl['reported']; ?>
                            <option value="<?= $rl['id'] ?>"
                    ...
                    <!-- ✅ Đã bỏ quantity_delivered — tính tự động từ delivery_note_items -->
                    <div class="alert alert-info small py-2 mb-3">
                        <i class="fas fa-info-circle me-1"></i>
                        <strong>Số lượng đã giao</strong> sẽ được tính tự động
                        từ các biên bản giao hàng.
                    </div>
...
document.getElementById('btnSaveOutput').addEventListener('click', () => {
    ...
    fetch('/erp/api/production/save_output.php', {
