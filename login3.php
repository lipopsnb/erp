...
<head>
    ...
    <style>
        ...
        .demo-accounts table td { padding: 2px 8px; }
        .demo-accounts .badge { font-size: 11px; }
    </style>
</head>
<body>
<div class="login-card">
    ...
    <!-- Tài khoản demo (xóa khi lên production) -->
    <div class="demo-accounts">
        <p class="fw-bold mb-2 text-muted">🔑 Password mặc định (password: <code>123456</code>)</p>
        <table class="table table-sm table-borderless mb-0">
            <tr><td><span class="badge bg-danger">Tài Khoản Đăng Nhập là mã Nhân Viên Ví Dụ: NV01</span></td><td></tr>
